...
export default async function postDataService(props: SoftwareEngineerResume): Promise<void> {
    try {
        const response = await fetch('http://localhost:8080/api/resumes/postResume', {
            method: 'POST',
            headers: {
